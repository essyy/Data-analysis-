...
there si also filtering to edit the data that is not required at that moment 

there is also use of slicer to break down the data by use of buttons to segment the data 
